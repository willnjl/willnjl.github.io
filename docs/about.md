...
Here is broad but not exhaustive overview of my skills and experience over the years as a developer. Feel free to ask me about anything you can see here or indeed anything not listed. I'm always open to sharing knowledge and experience! [See Work](work.md).

### AI Intelligence

Specialist in stateful, agentic LLM orchestration (e.g., LangChain) to build practical, multimodal AI applications. Focused on leveraging models (Gemini, Claude, GPT) for web integration, enhancing chatbots, content workflows, and interactive features.
