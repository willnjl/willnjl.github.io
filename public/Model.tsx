...
type ActionName = 'jellyfish|move_1' | 'jellyfish|move_2' | 'jellyfish|move_3' | 'jellyfish|move_4'
...
export default function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { scene, animations } = useGLTF('/purple-striped_jellyfish-v1-transformed.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        ...
        <skinnedMesh name="Object_442" geometry={nodes.Object_442.geometry} material={materials.JF_heart} skeleton={nodes.Object_442.skeleton} rotation={[-Math.PI / 2, 0.497, 0]} />
        <skinnedMesh name="Object_444" geometry={nodes.Object_444.geometry} material={materials.JF_skin_in} skeleton={nodes.Object_444.skeleton} rotation={[-Math.PI / 2, 0.497, 0]} />
        <skinnedMesh name="Object_446" geometry={nodes.Object_446.geometry} material={materials.JF_skin_out} skeleton={nodes.Object_446.skeleton} rotation={[-Math.PI / 2, 0.497, 0]} />
      </group>
    </group>
  )
}
